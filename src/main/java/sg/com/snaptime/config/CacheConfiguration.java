package sg.com.snaptime.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(sg.com.snaptime.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(sg.com.snaptime.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
